                            ...
                            <div class="row panel panel-default align-items-center" style="opacity: 0.8;">
                                <div class="row"  id="paypalhide">
                                    <div class="col-12 text-black text-center mb-2">
                                        <b class="text-danger">Important ! Do not put anything in PayPal notes but Your name.</b>
                                        <br>
                                ...
                                <div class="row " id="gpayhide">
                                    <div class="col-12 text-black text-center mb-2">
                                        <b class="text-danger">Important ! Do not put anything in Google Pay notes but Your name.</b>
                                        <br>
                                ...
                                <div class="row" id="creditcardhide"  style="padding-left: 40px;">
                                    <div class="col-12 text-black text-center mb-2">
                                        <b class="text-danger">Important ! Do not put anything in notes but Your name.</b>
                                        <br>
